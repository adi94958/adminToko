...
Route::group(['prefix' => 'dashboard/admin', 'middleware' => ['auth', 'checkRole:2']], function () {
    ...
    Route::controller(DatabasePenjualanController::class)
        ...
        ->group(function () {
            ...
            // Route::match(['get', 'post'], 'ubah/{kode_transaksi}', 'updatePenjualan')->name('update');
    ...
    Route::controller(DatabasePenjualanDetailController::class)
        ...
        ->group(function () {
            ...
            Route::post('dataTable', 'dataTable')->name('dataTable');
            // Route::match(['get', 'post'], 'tambah', 'tambahPenjualan')->name('add');
            Route::match(['get', 'post'], 'ubah/{id}', 'updateDetailPenjualan')->name('update');
    ...
    Route::controller(DatabasePembelianDetailController::class)
        ...
        ->group(function () {
            ...
            Route::post('dataTable', 'dataTable')->name('dataTable');
            // Route::match(['get', 'post'], 'tambah', 'tambahPenjualan')->name('add');
            //Route::match(['get', 'post'], 'ubah/{id}', 'updateDetailPembelian')->name('update');
